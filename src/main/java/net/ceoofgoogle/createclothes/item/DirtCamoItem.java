...
public abstract class DirtCamoItem extends BaseCreateClothesArmorItem {
    public DirtCamoItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.DIRT, type, properties);
    }
