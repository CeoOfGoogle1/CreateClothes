...
public abstract class PlainsCamoItem extends BaseCreateClothesArmorItem {
    public PlainsCamoItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.PLAINS, type, properties);
    }
