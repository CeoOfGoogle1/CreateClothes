...
public abstract class CrownItem extends BaseCreateClothesArmorItem {
    public CrownItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.CROWN, type, properties);
    }
    ...
    public static class Helmet extends CrownItem {
        ...
        public void initializeClient(Consumer<IClientItemExtensions> consumer) {
            initializeClientWithModel(consumer, living -> new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head", (new ModelCrown(Minecraft.getInstance().getEntityModels().bakeLayer(ModelCrown.LAYER_LOCATION))).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap())))));
        }
    }
}
