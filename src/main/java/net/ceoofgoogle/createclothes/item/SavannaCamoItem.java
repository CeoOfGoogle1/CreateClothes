...
public abstract class SavannaCamoItem extends BaseCreateClothesArmorItem {
    public SavannaCamoItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.SAVANNA, type, properties);
    }

    public static class Boots extends SavannaCamoItem {
        public Boots() {
            super(Type.BOOTS, new Properties().durability(Type.BOOTS.getDurability(15)));
        }
    }

    public static class Leggings extends SavannaCamoItem {
        public Leggings() {
            super(Type.LEGGINGS, new Properties().durability(Type.LEGGINGS.getDurability(15)));
        }
    }

    public static class Chestplate extends SavannaCamoItem {
        public Chestplate() {
    ...
    public static class Helmet extends SavannaCamoItem {
        public Helmet() {
