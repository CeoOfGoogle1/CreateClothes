...
public abstract class DesertCamoItem extends BaseCreateClothesArmorItem {
    public DesertCamoItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.DESERT, type, properties);
    }
    ...
    public static class Leggings extends DesertCamoItem {
        public Leggings() {
            super(Type.LEGGINGS, new Properties().durability(Type.LEGGINGS.getDurability(15)));
        }
    }

    public static class Chestplate extends DesertCamoItem {
        public Chestplate() {
    ...
    public static class Helmet extends DesertCamoItem {
        public Helmet() {
