...
public abstract class CapItem extends BaseCreateClothesArmorItem {
    public CapItem(ArmorItem.Type type, Properties properties) {
        super(CreateClothesModArmorMaterials.CAP, type, properties);
    }
